...
class Config:
    ...
    ##
    appName = 'Peeper'  # 应用名称
    appNameEN = 'peeper'    # 应用名称-英文（用于生成缓存文件夹，必须是英文）
    appVersion = "VAlpha1.0.0"  # 应用版本号
    appDeveloper = "JiangQinyu"  # 应用开发者
    appBlogs = "https://nyml2003.github.io"  # 个人博客
    appPackage = 'com.peeper'    # 应用包名，用于在本地电脑生成 vip.pangao.ppx 唯一文件夹
    appUpdateUrl = 'https://api.github.com/repos/nyml2003/peeper/releases/latest'    # 获取程序更新信息 https://api.github.com/repos/pangao1990/ppx/releases/latest
    appISSID = '11082B7B-5846-E604-2A99-A8BDA1119891'    # Inno Setup 打包唯一编号。在执行 pnpm run init 之前，请设置为空，程序会自动生成唯一编号，生成后请勿修改！！！
    ...
    cryptoKey = '7109218292600217'    # 对Python字节码加密。在执行 pnpm run init 之前，请设置为空，程序会自动生成密钥
