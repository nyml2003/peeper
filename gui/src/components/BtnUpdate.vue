<template>
  <div>
    <el-tooltip content="检测更新" effect="light" placement="bottom">
      <el-button key="plain" link size="small" @click="onCheckUpdate(false)">
        <SvgIcon
          :class="{ 'is-loading': state.btnLoading }"
          :name="state.btnLoading ? 'ele-Loading' : 'icon-Update'"
          :size="20"
        ></SvgIcon>
      </el-button>
    </el-tooltip>
    ...
    >
      <div>
        <SvgIcon
          ...
          :size="18"
          color="#67C23A"
          name="ele-SuccessFilled"
          style="top: 4px"
        ></SvgIcon>
        <SvgIcon
          v-else-if="state.code == 0"
          :size="18"
          color="#E6A23C"
          name="ele-WarningFilled"
          style="top: 4px"
        ></SvgIcon>
        <SvgIcon
          v-else-if="state.code == -1"
          :size="18"
          color="#F56C6C"
      ...
      <template #footer>
        <span class="dialog-footer">
          <el-link
            ...
            >手动更新</el-link
          >
          <el-button v-if="state.code == 0" @click="state.checkVisible = false"
            >取消</el-button
          >
    ...
    >
      ...
      <div v-if="state.htmlUrl != ''" class="tip">
        若网速不理想，请尝试
        <span
          ><el-link class="tip-sd" type="primary" @click="onOpenLink"
            >手动更新</el-link
          ></span
        >
      </div>
